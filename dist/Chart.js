...
Chart = function(_Component) {
    ...
    },
    {
        ...
        value: function _computeBounds() {
            ...
            // min = Math.round(min);
            min = 0; // TODO 从0开始计算 laozhao
            max = Math.round(max); // Exit if we want tight bounds
            ...
            if (min < 0) {
                ...
                if (Math.abs(min) > Math.abs(max)) {
                    var m = Math.ceil(Math.abs(min) / step);
                    newMin = step * m * (min > 0 ? 1 : -1);
                    newMax = step * (this.props.verticalGridStep - m) * (max > 0 ? 1 : -1);
                } else {
                    var _m = Math.ceil(Math.abs(max) / step);
                    newMax = step * _m * (max > 0 ? 1 : -1);
                    newMin = step * (this.props.verticalGridStep - _m) * (min > 0 ? 1 : -1);
                }
                if (min < newMin) {
                    newMin -= step;
                    newMax -= step;
    ...
    {
        key: '_minVerticalBound',
        value: function _minVerticalBound()
    ...
    {
        key: '_maxVerticalBound',
        value: function _maxVerticalBound()
    ...
    },
    {
...

        {
            ...
            return (_react2.
        default.createElement(_reactNative.View, {
                __source: {
            ...
            function() {
                var ChartType = components[_this2.props.type] || _BarChart2.
            default;
                if (_this2.props.showAxis && Chart !== _PieChart2.
            default) {
                    return (_react2.
                default.createElement(_reactNative.View, {
                        ref: 'container',
                ...
                default, _extends({},
                    ...
                    _react2.
                default.createElement(ChartType, _extends({},
                    _this2.props, {
                        data: _this2.props.data,
                    ...
                    default, _extends({},
                        _this2.props, {
                            ...
                            align: axisAlign,
                            style: {
                                marginLeft: _this2.props.yAxisWidth - 1
                            },
                            __source: {
                                fileName: _jsxFileName,
                                lineNumber: 187
