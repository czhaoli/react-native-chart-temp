...
YAxis = function(_Component) {
    ...
    function YAxis(props) {
        ...
        _createLabelForYAxis = function(index, i, arr) {
            ...
            if(index === 0){
              ...
              label = minBound + (maxBound - minBound) / (arr.length - 1) * index;
            }
            ...
            return (_react2.
        default.createElement(_reactNative.Text, {
                style: {
    ...
    _createClass(YAxis, [{
        ...
        default.createElement(_reactNative.View, {
                style: [styles.yAxisContainer, this.props.style || {},
